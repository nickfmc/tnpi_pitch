    ...
    <div class="c-page-header-upper">
      <div class="o-wrapper-wide">
        <div class="c-page-header-upper-inner" role="contentinfo" aria-label="Emergency Contact">
            <span>Emergency Line: <a href="tel:18003610608" aria-label="Call TNPI Emergency Line at 1-800-361-0608">1-800-361-0608</a></span>
        </div>
      </div>
    </div>
    ...
    <div class="o-wrapper-wide  u-relative">
        ...
        <div class="c-cl-mobile-nav">
          <button href="#" id="open-modal-nav" class="c-modal-nav-button" aria-haspopup="true" aria-expanded="false" aria-label="Open menu">
            <svg role="presentation" width="100%" height="100%" viewBox="0 0 12 9" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
       ...
       <a href="/" class="c-lang-select-btn c-lang-select--current" id="lang-en" aria-label="Select English">EN</a>
        <a href="https://ptni.ca/" class="c-lang-select-btn" id="lang-fr" aria-label="Select French">FR</a>
</div>
          ...
          <div class="x-body-wrapper"></div>
            <div id="modal-nav-wrap" class="c-modal-nav-wrap" tabindex="-1"  aria-modal="true" hidden>
              ...
              <svg role="presentation" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 50 50"><path fill="currentColor" d="m37.304 11.282l1.414 1.414l-26.022 26.02l-1.414-1.413z"/><path fill="currentColor" d="m12.696 11.282l26.022 26.02l-1.414 1.415l-26.022-26.02z"/></svg>
              </button>
...
<form role="search" method="get" id="search-form" class="c-search-form" action="<?php echo home_url( '/' ); ?>">
    <div class="search-wrapper">
        ...
        <label for="search-input" class="u-visually-hidden">Search this website</label>
